	...
	<i class="icon-shopping-cart"></i><a href="pedidos.php"> Pedidos</a><span class="divider">/</span></li>
			...
			<div class="row-fluid sortable">
                ...
                <div class="box-header well" data-original-title>
                  <h2><i class="icon-edit"></i> Formulario de Consulta de Pedidos de Productos a Proveedores </h2>
                  <div class="box-icon">  
<a href="#" class="btn btn-minimize btn-round" title="Desplegar" data-rel="tooltip"><i class="icon-chevron-up"></i></a>
				</div>
                </div>
			    <div class="box-content">
                  <form id="form1" name="form1" class="form-horizontal" method="post" action="reporte_pedido.php" target="_blank">
                    <fieldset>
