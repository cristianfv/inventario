	...
	<i class="icon-shopping-cart"></i><a href="pedidos.php"> Pedidos</a><span class="divider">/</span></li>
			...
			<div class="row-fluid sortable">
                ...
                <div class="box-header well" data-original-title>
                  <h2><i class="icon-edit"></i> Formulario de Registros de Proveedores </h2>
                  <div class="box-icon">  
...
if(isset($_POST['txtRut']) && isset($_POST['nombreprov']) ) {
	...
	mysql_query("select * from proveedores where rutprov = '".$rutprov."'") or die(mysql_error());
			if (mysql_affected_rows() == 0) {
			
		mysql_query("insert into proveedores (rutprov,nombreprov,telefprov,direcprov,ciudadprov,regionprov,giroprov,emailprov,nomcontacto) values ('".mysql_real_escape_string($rutprov)."','".mysql_real_escape_string($nombreprov)."','".mysql_real_escape_string($telefprov)."','".mysql_real_escape_string($direcprov)."','".mysql_real_escape_string($ciudadprov)."','".mysql_real_escape_string($regionprov)."','".mysql_real_escape_string($giroprov)."','".mysql_real_escape_string($emailprov)."','".mysql_real_escape_string($nomcontacto)."')") or die(mysql_error());
		
    echo"<div class='alert alert-success'>";
	echo"<button type='button' class='close' data-dismiss='alert'>×</button>";
	echo"<center>EL PROVEEDOR $nombreprov FUE REGISTRADO SATISFACTORIAMENTE</div>";
	echo '<br>';
	...
	echo"<button type='button' class='close' data-dismiss='alert'>×</button>";
	echo"<center>ERROR! YA EXISTE UN PROVEEDOR CON EL NUMERO DE RUT $rutprov</div>";
	echo '<br>';
 ...
 ?>
                  <form id="form1" name="form1" class="form-horizontal" method="post" action="">
                    ...
                    <div class="control-group">
                      ...
                      <input name="txtRut" type="text" autocomplete="off" class="input-xlarge focused" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese RFC de Proveedor" id="txtRut" required="required">
                      </div>
                    </div>
					</div> 
                      <div class="control-group">
                    ...
                    <input name="nombreprov" type="text" class="input-xlarge focused" onKeyUp="this.value=this.value.toUpperCase();" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ.\s]+{3,80}" autocomplete="off" placeholder="Ingrese Nombre de Proveedor" id="nombreprov" required="required">
                      </div>
                      </div>
					  </div>
                      <div class="control-group">
               ...
               <input name="telefprov" type="text" class="input-xlarge focused" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Telefono de Proveedor" autocomplete="off" id="telefprov" required="required">
                      </div>
                      </div>
					  </div>
                     <div class="control-group">
					  ...
					  <div class="input-prepend" title="Ingrese Direccion Proveedor" data-rel="tooltip">
                       <input name="direcprov" type="text" class="input-xlarge focused" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Direccion de Proveedor" id="direcprov" required="required">
                      </div>
                    </div>
					</div>
					<div class="control-group">
					  ...
					  <div class="input-prepend" title="Ingrese Ciudad Proveedor" data-rel="tooltip">
                       <input name="ciudadprov" type="text" class="input-xlarge focused" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Ciudad de Proveedor" id="ciudadprov" required="required">
                      </div>
                    </div>
					</div>
					<div class="control-group">
					  ...
					  <div class="input-prepend" title="Ingrese Región Proveedor" data-rel="tooltip">
                       <input name="regionprov" type="text" class="input-xlarge focused" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Región de Proveedor" id="regionprov" required="required">
                      </div>
                    </div>
					</div>
					<div class="control-group">
					  ...
					  <div class="input-prepend" title="Ingrese Giro Proveedor" data-rel="tooltip">
                       <input name="giroprov" type="text" class="input-xlarge focused" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Giro de Proveedor" id="giroprov" required="required">
                      </div>
                    </div>
					</div>
                      <div class="control-group">
					  ...
					  <div class="input-prepend" title="Ingrese un Correo Electronico valido" data-rel="tooltip">
                         <span class="add-on"><i class="icon-envelope"></i></span><input name="emailprov" type="email" class="input-xlarge focused" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Correo de Proveedor" id="emailprov">
                      </div>
                    </div>
					</div>
                      <div class="control-group">
                      ...
                      <input name="nomcontacto" type="text" class="input-xlarge focused" onKeyUp="this.value=this.value.toUpperCase();" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ.\s]+{3,80}" autocomplete="off" placeholder="Ingrese Nombre de Contacto" id="nomcontacto" required="required">
                      </div>
                    </div>
					</div>
