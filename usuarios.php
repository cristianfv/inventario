			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i> Consulta General de Usuarios </h2>
						<div class="box-icon"> 
<a href="#" class="btn btn-minimize btn-round" title="Desplegar" data-rel="tooltip"><i class="icon-chevron-up"></i></a>
	   ...
	   if (isset($_GET['eliminar'])) {
		...
		$rut_usuario = base64_decode($_GET['rut_usuario']); 
		
		if ($elimina == 'eliminar_usuario') {
		
		mysql_query("select * from ventas where vendedor = '".$rut_usuario."'") or die(mysql_error());
		if (mysql_affected_rows() == 0) {
		
		mysql_query("delete from usuarios where rut_usuario = '".mysql_real_escape_string($rut_usuario)."'") or die(mysql_error());
			
		echo '<br>';
		echo"<div class='alert alert-block'>";
	    echo"<button type='button' class='close' data-dismiss='alert'>×</button>";
	    echo"<strong>EL USUARIO HA SIDO ELIMINADO SATISFACTORIAMENTE</strong></div>";
	   ...
	   echo '<br>';
		echo"<div class='alert alert-block'>";
	    echo"<button type='button' class='close' data-dismiss='alert'>×</button>";
	    echo"<strong>NO PUEDE SER ELIMINADO, ESTE USUARIO ESTA RELACIONADO CON VENTAS EXISTENTES</strong></div>";
			}
		}
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  <thead>
							  <tr>
								  ...
								  <th><div align="center"><span data-reactid=".zg.$mid=11434258871829=2796879f53f0f46fb68.2:0.0.0.0.0"><span data-reactid=".zg.$mid=11434258871829=2796879f53f0f46fb68.2:0.0.0.0.0.0">RFC</span></span> Usuario</div></th>
...
?>
							<tr>
								...
								<td class="center"><div align="center"><?php echo $array["cedula"]; ?></div></td>
								<td class="center"><div align="center"><?php echo $array["nombre"]; ?></div></td>
								<td class="center"><div align="center"><?php echo $array["nivel"]; ?></div></td>
								<td class="center">
<a class="btn btn-info ask" href="modifica_usuarios.php?id=<?php echo base64_encode($array['id']); ?>" title="Modificar Usuario" data-rel="tooltip" onClick="return confirm('&iquest;Esta seguro que desea Modificar los datos del Usuario?')"><i class="icon-edit icon-white"></i>Edita</a>
<a class="btn btn-danger" href="usuarios.php?eliminar=<?php echo base64_encode('eliminar_usuario'); ?>&rut_usuario=<?php echo base64_encode($array['rut_usuario']); ?>" title="Eliminar Usuario" data-rel="tooltip"  onClick="return confirm('&iquest;Esta seguro que desea Eliminar este Usuario?')"><i class="icon-trash icon-white"></i>Elimina</a>								</td>
							</tr><?php } ?>
						  </tbody>
					  </table>            
					</div>
