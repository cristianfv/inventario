			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-eye-open"></i> Consulta General de Logs de Usuarios </h2>
						<div class="box-icon"> 
					  ...
					  <table class="table table-striped table-bordered bootstrap-datatable datatable">
                        <thead>
                          <tr>
                            ...
                            <th><div align="center">Tiempo</div></th>
                            <th><div align="center">Detalles</div></th>
                            <th><div align="center">Paginas</div></th>
...
?>
                          <tr>
                            <td><div align="center"><?php echo $array["id"]; ?></div></td>
                            <td class="center"><div align="center"><?php echo $array["ip"]; ?></div></td>
                            <td class="center"><div align="center"><?php echo $array["tiempo"]; ?></div></td>
                            <td class="center"><div align="center"><?php echo $array["detalles"]; ?></div></td>
                            <td class="center"><div align="center"><?php echo $array["paginas"]; ?></div></td>
                            <td class="center"><div align="center"><?php echo $array["usuario"]; ?></div></td>
                          </tr>
                          <?php } ?>
                        </tbody>
                      </table>
