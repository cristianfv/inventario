...
<li><a class="ajax-link" href="logout.php"><i class="icon-off"></i><span class="hidden-tablet"> Cerrar Sesión</span></a></li>
			...
			<div class="row-fluid sortable">
                ...
                <div class="box-header well" data-original-title>
                  <h2><i class="icon-edit"></i> Formulario de Actualización de Clientes </h2>
                  <div class="box-icon">  
...
if(isset($_POST['txtRut']) && isset($_POST['nombrecliente']) ) {
	...
	$cod_cliente= limpiar($_POST['cod_cliente']);
	...
	mysql_query("update clientes set rutcliente = '".mysql_real_escape_string($rutcliente)."',nombrecliente = '".mysql_real_escape_string($nombrecliente)."',telefcliente = '".mysql_real_escape_string($telefcliente)."',direccliente = '".mysql_real_escape_string($direccliente)."',ciudadcliente = '".mysql_real_escape_string($ciudadcliente)."',regioncliente = '".mysql_real_escape_string($regioncliente)."',girocliente = '".mysql_real_escape_string($girocliente)."',emailcliente = '".mysql_real_escape_string($emailcliente)."',contactocliente = '".mysql_real_escape_string($contactocliente)."' where cod_cliente = '".$cod_cliente."'") or die(mysql_error());
	
		
	echo"<div class='alert alert-block'>";
	echo"<button type='button' class='close' data-dismiss='alert'>×</button>";
	echo"<center>EL CLIENTE $nombrecliente FUE ACTUALIZADO SATISFACTORIAMENTE</div>";
 ...
 ?>
 <?php 
$cod_cliente = limpiar(base64_decode($_GET['cod_cliente']));
$sql1 = mysql_query("select * from clientes WHERE cod_cliente = $cod_cliente") or die(mysql_error());
$array1 = mysql_fetch_array($sql1);
 ?>
				...
				<input name="txtRut" type="text" autocomplete="off" class="input-xlarge focused" onKeyUp="this.value=this.value.toUpperCase();" value="<?php echo $array1['rutcliente']; ?>" placeholder="Ingrese RFC de Cliente" id="txtRut" required="required">
					  </div>
                    </div>
					</div> 
                      <div class="control-group">
                    ...
                    <input name="nombrecliente" type="text" class="input-xlarge focused" onKeyUp="this.value=this.value.toUpperCase();" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ.\s]+{3,80}" value="<?php echo $array1['nombrecliente']; ?>" autocomplete="off" placeholder="Ingrese Nombre de Cliente" id="nombrecliente" required="required">
                      </div>
                      </div>
					  </div>
                      <div class="control-group">
					  ...
					  <div class="input-prepend" title="Ingrese solo numeros para telefono" data-rel="tooltip">
					    <input name="telefcliente" type="text" class="input-xlarge focused" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Telefono de Cliente" value="<?php echo $array1['telefcliente']; ?>" autocomplete="off" id="telefcliente" required="required">
					  </div>
                      </div>
					  </div>
                     <div class="control-group">
                      <label class="control-label" for="inputWarning">Dirección Cliente: </label>
                      <div class="controls">
					  <div class="input-prepend" title="Ingrese Direccion Proveedor" data-rel="tooltip">
                       <input name="direccliente" type="text" class="input-xlarge focused" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" value="<?php echo $array1['direccliente']; ?>" placeholder="Ingrese Direccion de Cliente" id="direccliente" required="required">
                      </div>
                    </div>
					</div>
					<div class="control-group">
					  ...
					  <div class="input-prepend" title="Ingrese Ciudad Cliente" data-rel="tooltip">
                       <input name="ciudadcliente" type="text" class="input-xlarge focused" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" value="<?php echo $array1['ciudadcliente']; ?>" placeholder="Ingrese Cliente de Cliente" id="ciudadcliente" required="required">
                      </div>
                    </div>
					</div>
					<div class="control-group">
                      <label class="control-label" for="inputWarning">Región Cliente: </label>
                      <div class="controls">
					  <div class="input-prepend" title="Ingrese Región Cliente" data-rel="tooltip">
                       <input name="regioncliente" type="text" class="input-xlarge focused" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" value="<?php echo $array1['regioncliente']; ?>" placeholder="Ingrese Región de Cliente" id="regioncliente" required="required">
                      </div>
                    </div>
					</div>
					<div class="control-group">
					  ...
					  <div class="input-prepend" title="Ingrese Giro Cliente" data-rel="tooltip">
                       <input name="girocliente" type="text" class="input-xlarge focused" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" value="<?php echo $array1['girocliente']; ?>" placeholder="Ingrese Giro de Cliente" id="girocliente" required="required">
                      </div>
                    </div>
					</div>
                      <div class="control-group">
					  ...
					  <div class="input-prepend" title="Ingrese un Correo Electronico valido" data-rel="tooltip">
                         <span class="add-on"><i class="icon-envelope"></i></span><input name="emailcliente" type="email" class="input-xlarge focused" onKeyUp="this.value=this.value.toUpperCase();" value="<?php echo $array1['emailcliente']; ?>" autocomplete="off" placeholder="Ingrese Correo de Cliente" id="emailcliente">
                      </div>
                    </div>
					</div>
                      <div class="control-group">
                      ...
                      <input name="contactocliente" type="text" class="input-xlarge focused" onKeyUp="this.value=this.value.toUpperCase();" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ.\s]+{3,80}" value="<?php echo $array1['contactocliente']; ?>" autocomplete="off" placeholder="Ingrese Nombre de Contacto" id="contactocliente" required="required">
                      </div>
                    </div>
					</div>
			...
			<input name="cod_cliente" type="hidden" cod_proveedor="cod_cliente" value="<?php echo $array1['cod_cliente']; ?>" />
                      </div>
                    </fieldset>
                  </form>
		        </div>
