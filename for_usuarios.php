			...
			<div class="row-fluid sortable">
			  <div class="box span12">
                <div class="box-header well" data-original-title>
                  <h2><i class="icon-edit"></i> Formulario de Registros de Usuarios </h2>
                  <div class="box-icon">  
...
if(isset($_POST['usuario']) && isset($_POST['clave']) ) {
	...
	$array2 = mysql_fetch_array($sql2); 
			...
			mysql_query("select * from usuarios where cedula = '".$cedula."'") or die(mysql_error());
			if (mysql_affected_rows() == 0) {
			
			
		mysql_query("insert into usuarios (cedula,nombre,cargo,usuario,password,pregunta,respuesta,nivel) values ('".mysql_real_escape_string($rut_usuario)."','".mysql_real_escape_string($nombre)."','".mysql_real_escape_string($cargo)."','".mysql_real_escape_string($usuario)."','".mysql_real_escape_string($clave)."','".mysql_real_escape_string($pregunta)."','".mysql_real_escape_string($respuesta)."','".mysql_real_escape_string($nivel)."')") or die(mysql_error());
		
		 echo"<div class='alert alert-success'>";
	echo"<button type='button' class='close' data-dismiss='alert'>×</button>";
	echo"<center>EL USUARIO $nombre FUE REGISTRADO SATISFACTORIAMENTE</div>";
		echo '<br>';
	...
	echo"<button type='button' class='close' data-dismiss='alert'>×</button>";
	echo"<center>YA EXISTE UN USUARIO CON ESTE NUMERO DE RUT, VERIFIQUE DE NUEVO POR FAVOR</div>";
	echo '<br>';
 ...
 ?>
                  <form id="form1" name="form1" class="form-horizontal" method="post" action="">
                    ...
                    <div class="control-group">
					  ...
					  <div class="input-prepend" title="Ingrese Rut valido" data-rel="tooltip">
                        <input name="txtRut" type="text" class="input-xlarge focused" onKeyUp="this.value=this.value.toUpperCase();" onBlur="onRutBlur(this);" autocomplete="off" placeholder="Ingrese Rut" id="txtRut" required="required">
                      </div>
                    </div>
					</div>
                      <div class="control-group">
					  ...
					  <div class="input-prepend" title="Ingrese solo letras para Nombres" data-rel="tooltip">
                        <input name="nombre" type="text" class="input-xlarge focused" onKeyUp="this.value=this.value.toUpperCase();" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ.\s]+{3,80}" autocomplete="off" placeholder="Ingrese su Nombre" id="nombre" required="required">
                      </div>
                      </div>
					  </div>
                      <div class="control-group">
					  ...
					  <div class="input-prepend" title="Ingrese solo letras para Cargo" data-rel="tooltip">
                        <input name="cargo" type="text" class="input-xlarge focused" onKeyUp="this.value=this.value.toUpperCase();" pattern="[A-Za-z ]{1,35}" placeholder="Ingrese su Cargo" id="cargo" autocomplete="off" required="required">
                      </div>
                      </div>
					  </div>
                     <div class="control-group">
					  ...
					  <div class="input-prepend" title="Ingrese su Usuario" data-rel="tooltip">
                        <input name="usuario" type="text" class="input-xlarge focused" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese su Usuario" autocomplete="off" id="usuario" required="required">
                      </div>
                    </div>
					</div>
                      <div class="control-group">
					  ...
					  <div class="input-prepend" title="Ingrese su Clave" data-rel="tooltip">
                        <span class="add-on"><i class="icon-lock"></i></span><input name="clave" type="text" class="input-xlarge focused" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese su Clave" autocomplete="off" id="clave" required="required">
                      </div>
                    </div>
					</div>
                      <div class="control-group">
					  ...
					  <div class="input-prepend" title="Repita su Clave" data-rel="tooltip">
                        <span class="add-on"><i class="icon-lock"></i></span><input name="clave1" type="text" class="input-xlarge focused" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Repita su Clave" id="clave1" required="required">
                      </div>
                    </div>
					</div>
                      <div class="control-group">
    ...
    <option value="NOMBRE DE TU PRIMER PROFESOR">NOMBRE DE TU PRIMER PROFESOR</option>
                      ...
                      <input name="respuesta" type="text" class="input-xlarge focused" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Respuesta Secreta" id="respuesta" required="required">
                      </div>
                    </div>
					</div>
                      <div class="control-group">
