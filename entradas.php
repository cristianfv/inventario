			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-shopping-cart"></i> Consulta General de Compras de Productos (Entradas)</h2>
						<div class="box-icon"> 
<a href="#" class="btn btn-minimize btn-round" title="Desplegar" data-rel="tooltip"><i class="icon-chevron-up"></i></a>
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  <thead>
							  <tr>
							    <th><div align="center">Código</div></th>
								  <th><div align="center">Cód. Prod</div></th>
						  ...
						  <tbody>
						  <?php 
$sql = mysql_query("SELECT * FROM orden_compras ") or die(mysql_error());
while($array=mysql_fetch_array($sql)) {  
?>
							<tr>
							  <td><div align="center"><?php echo $array["cod_orden"]; ?></div></td>
								<td><div align="center"><?php echo $array["cod_material"]; ?></div></td>
								<td class="center"><div align="center"><?php echo $array["material"]; ?></div></td>
								<td class="center"><div align="center"><?php echo $array["precio_compra"]; ?></div></td>
								<td class="center"><div align="center"><?php echo $array["cant"]; ?></div></td>
...
$regi=mysql_fetch_array($sql1);
								...
								<td class="center">
<a class="btn btn-info ask" href="modifica_entrada.php?cod_orden=<?php echo base64_encode($array['cod_orden']); ?>" title="Modificar Entrada" data-rel="tooltip" onClick="return confirm('&iquest;Esta seguro que desea Modificar esta Entrada de Producto?')"><i class="icon-edit icon-white"></i>Edita</a>							</td>
							</tr><?php } ?>
						  </tbody>
					  </table>            
					</div>
