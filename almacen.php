			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-tasks"></i> Consulta General de Productos en Almacen</h2>
						<div class="box-icon"> 
						  ...
						  <thead>
							  <tr>
							    <th><div align="center">Código</div></th>
								  ...
								  <th><div align="center">Exist.</div></th>
								  <th><div align="center">Min. Stock</div></th>
...
?>
							<tr>
							  <td><div align="center"><?php echo $array["cod_material"]; ?></div></td>
								<td><div align="center"><?php $sql1 = mysql_query("select * from orden_compras where cod_material = '".$array['cod_material']."'") or die("Problemas en el select:".mysql_error());
$regi=mysql_fetch_array($sql1);
echo $regi["material"]; ?></div></td>
								<td class="center"><div align="center"><?php echo $array["precio_venta"]; ?></div></td>
								<td class="center"><div align="center"><?php echo $array["existencia"]; ?></div></td>
								<td class="center"><div align="center"><?php echo $array["minimo_stock"]; ?></div></td>
								<td class="center"><div align="center"><?php echo $array["ubicacion_deposito"]; ?></div></td>
								<td class="center"><div align="center"><?php if($array["status_material"]=='ACTIVO') { ?><span class="label label-success"><?php echo $array["status_material"];  } else { ?></span><span class="label label-important"><?php echo $array["status_material"];  } ?></span></div></td>
								<td class="center">
<a class="btn btn-info ask" href="modifica_material.php?cod_orden=<?php echo base64_encode($array['cod_orden']); ?>" title="Modificar Producto" data-rel="tooltip" onClick="return confirm('&iquest;Esta seguro que desea Modificar este Producto en Almacen?')"><i class="icon-edit icon-white"></i>Edita</a>							</td>
							</tr><?php } ?>
						  </tbody>
					  </table>            
					</div>
